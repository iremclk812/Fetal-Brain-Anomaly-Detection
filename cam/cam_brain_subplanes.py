...
ROOT_DIR = "../3904280/FETAL_PLANES_ZENODO/Images"
PATH_CSV = "../3904280/FETAL_PLANES_ZENODO/FETAL_PLANES_DB_data.csv"
PATH_FETALCLIP_WEIGHT = "FetalCLIP_weights.pt"
PATH_FETALCLIP_CONFIG = "FetalCLIP_config.json"
PATH_TEXT_PROMPTS = "cam/test_brain_subplanes_prompts.json"
...
ds = DatasetFetalPlanesDBBrain(ROOT_DIR, PATH_CSV, preprocess, split='all')
